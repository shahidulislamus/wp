...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      ...
      array(
        'id'          => 'header_option',
        'title'       => __( 'header customize', 'theme-text-domain' )
      ), 
      array(
        'id'          => 'footer_option',
        'title'       => __( 'footer customize', 'theme-text-domain' )
      )
    ),
    'settings'        => array(
     array(
        ...
        'id'=>'logo_id',
        'label'=>'logo chenge',
        'desc'=>'hear you can chenge your logo and also you can use text logo',
        'type'=>'text',
        'std'=>'<span>s</span>hahidul <span>i</span>slam',
     ),
     array(
        'section'=>'header_option',
        'id'=>'logo_link_id',
     ...
     array(
        'section'=>'header_option',
        'id'=>'footer_id',
        'label'=>'footer text chenge',
        'desc'=>'hear you can chenge your footer and also you can use text logo',
        'type'=>'text',
     ),
      array(
        'id'          => 'demo_background',
